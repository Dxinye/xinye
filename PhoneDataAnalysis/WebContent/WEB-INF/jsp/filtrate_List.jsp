...
<head>
	...
	<script type="text/javascript">
		...
		//导出全部数据
		function outFiltrate1(){
			add();
			$.ajax({
				url: "${pageContext.request.contextPath}/originalData_filtrateData.action",
...
<body>
	...
	<table id="dg" title="分类后数据" class="easyui-datagrid" style="width:90%px;height:90%px"
	...
	<div id="toolbar">
		...
		<a class="easyui-linkbutton" href="javascript:outFiltrate1()">导出全部数据</a>
		<%-- <div id="tb" style="padding:3px">
			<span style="color:red">客服流水号:</span>
			<input id="productid" style="line-height:26px;border:1px solid #ccc">
			<a href="#" class="easyui-linkbutton" plain="true" onclick="doSearch()">Search</a>
		</div> --%>
		<form id="ff" action="${pageContext.request.contextPath}/originalData_filtrateByDate.action" method="post">
			<span style="color:red">根据时间导出数据：</span>
			开始时间:
			<input class="easyui-datetimebox" name="filtrateDate" data-options="required:true,showSeconds:true" style="width:150px">
			结束时间:
			<input class="easyui-datetimebox" name="filtrateDate1" data-options="required:true,showSeconds:true" style="width:150px">
