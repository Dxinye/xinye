...
<head>
	...
	<script type="text/javascript">
		...
		function addTab(title,url){
			//alert(kkwe);
			if(kkwe != null){
				url = "${pageContext.request.contextPath}/key_keyFirst.action?id="+kkwe;	
			}
...
<body class="easyui-layout">
	...
	<div data-options="region:'north',border:false" style="height:50px;background:#B3DFDA;padding:5px">
		<div class="easyui-panel" style="padding:5px;">	
			...
			<a href="#" class="easyui-linkbutton" onclick="addTab('关键字','')">关键字</a>
		...
		<div id="mm2" style="width:100px;">
			...
			<div><a class="easyui-linkbutton" href="#" onclick="addTab('根据时间分类','${pageContext.request.contextPath}/login_filtrateByDate.action')">根据时间分类</a></div>
		</div>
