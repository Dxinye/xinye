...
<head>
	...
	<script type="text/javascript">
		...
		function outFiltrate1(){
			//add();
			$.ajax({
				url: "${pageContext.request.contextPath}/filtrate_outFiltrate.action",
...
<body>
	...
	<div id="toolbar">
		...
		<%-- <form id="ff" action="${pageContext.request.contextPath}/filtrate_findByDate.action" method="post">
