...
<body class="easyui-layout">
	...
	<div data-options="region:'north',border:false" style="height:50px;background:#B3DFDA;padding:5px">
		<div class="easyui-panel" style="padding:5px;">	
			...
			<!-- <a class="easyui-linkbutton" href="javascript:sort()">分类</a> -->  
		...
		<div id="mm2" style="width:100px;">
			...
			<div><a class="easyui-linkbutton" href="#" onclick="addTab('分类后数据','${pageContext.request.contextPath}/filtrate_filtrateListRank3.action')">分类后数据</a></div>
			...
			<div><a class="easyui-linkbutton" href="#" onclick="addTab('原数据','${pageContext.request.contextPath}/originalData_originalListRank3.action')">原数据</a></div>
