...
(function($){
	...
	$.fn.etree.defaults = $.extend({}, $.fn.tree.defaults, {
		...
		dnd:true,
		url:'${pageContext.request.contextPath}/index_indexSelectById.action',	// return tree data
		createUrl:'${pageContext.request.contextPath}/index_insertIndex.action',	// post parentId, return the created node data{id,text,...}
		updateUrl:'${pageContext.request.contextPath}/index_updateIndex.action',	// post id,text, return updated node data.
		destroyUrl:'${pageContext.request.contextPath}/index_deleteIndex.action',	// post id, return {success:true}
